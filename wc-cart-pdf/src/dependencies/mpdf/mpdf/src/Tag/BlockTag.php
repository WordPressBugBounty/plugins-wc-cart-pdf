...
use WCCartPDF\Mpdf\Conversion\DecToAlpha;
use WCCartPDF\Mpdf\Conversion\DecToRoman;
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if ((isset($p['POSITION'])
			...
			if ($this->mpdf->inFixedPosBlock) {
				throw new \WCCartPDF\Mpdf\MpdfException('Cannot nest block with position:fixed or position:absolute');
			}
