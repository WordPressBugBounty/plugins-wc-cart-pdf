...
namespace WCCartPDF\setasign\Fpdi\PdfReader;

use WCCartPDF\setasign\Fpdi\FpdiException;
use WCCartPDF\setasign\Fpdi\GraphicsState;
use WCCartPDF\setasign\Fpdi\Math\Vector;
